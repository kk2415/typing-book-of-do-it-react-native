...
export const styles = StyleSheet.create({
  ...
  name: {marginRight: 5, fontSize: 22, fontWeight: '500', color: MD2Colors.black},
  email: {
  ...
  text: {fontSize: 16, color: MD2Colors.black},
  comments: {marginTop: 10, fontSize: 16, color: MD2Colors.black},
