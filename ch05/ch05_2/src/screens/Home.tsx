...
export default function Home() {
	...
	const add = useCallback(() => setPeople((people) => [...people, D.createRandomPerson()]), [])
	const removeAll = useCallback(() => setPeople((notUsed) => []), [])

	const flatListRef = useRef<FlatList | null>(null)
	const onContentSizeChange = useCallback(() => flatListRef.current?.scrollToEnd(), [flatListRef.current])
